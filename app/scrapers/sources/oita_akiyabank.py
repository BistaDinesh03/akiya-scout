"""
Oita Akiya Bank scraper (placeholder - access under review)
"""
import logging
...
class OitaAkiyaBankScraper(HTMLScraper):
    """
    Scraper for Oita municipal Akiya bank.
    Status: Access under review - SSL certificate verification failed.
    """
    
    BASE_URL = "https://www.city.oita.lg.jp"
    SOURCE_STATUS = "under_review"
    
    def get_source_name(self) -> str:
        """Return the source name."""
        return "oita_akiyabank"
