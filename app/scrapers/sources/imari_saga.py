"""
Imari City Akiya Bank scraper (Saga Prefecture)
Source: https://www.city.imari.saga.jp/akiya/
...
class ImariSagaScraper(HTMLScraper):
    """
    Scraper for Imari City Akiya Bank.
    Status: Data confirmed to exist but hosted on restricted platform.
    """
    
    BASE_URL = "https://www.city.imari.saga.jp"
